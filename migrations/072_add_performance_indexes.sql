...
-- Date: 2026-01-16
-- Note: CONCURRENTLY removed to allow running in transaction (safer for migration rollback)
...
CREATE INDEX IF NOT EXISTS idx_course_instructors_lookup
...
CREATE INDEX IF NOT EXISTS idx_course_signups_student_lookup
...
CREATE INDEX IF NOT EXISTS idx_course_signups_status
ON course_signups(student_id, signup_status);
...
CREATE INDEX IF NOT EXISTS idx_course_materials_ordering
...
CREATE INDEX IF NOT EXISTS idx_course_materials_session
...
CREATE INDEX IF NOT EXISTS idx_forum_posts_ordering
...
CREATE INDEX IF NOT EXISTS idx_forum_posts_resolved
...
CREATE INDEX IF NOT EXISTS idx_forum_answers_ordering
...
CREATE INDEX IF NOT EXISTS idx_forum_answers_course
...
CREATE INDEX IF NOT EXISTS idx_course_sessions_ordering
...
CREATE INDEX IF NOT EXISTS idx_session_attendance_student_lookup
ON session_attendance(student_id, attendance_status);

-- Index for session attendance by signup
-- Used in: fetching attendance for a specific signup
CREATE INDEX IF NOT EXISTS idx_session_attendance_signup
...
-- DROP INDEX IF EXISTS idx_course_instructors_lookup;
-- DROP INDEX IF EXISTS idx_course_signups_student_lookup;
-- DROP INDEX IF EXISTS idx_course_signups_status;
-- DROP INDEX IF EXISTS idx_course_materials_ordering;
-- DROP INDEX IF EXISTS idx_course_materials_session;
-- DROP INDEX IF EXISTS idx_forum_posts_ordering;
-- DROP INDEX IF EXISTS idx_forum_posts_resolved;
-- DROP INDEX IF EXISTS idx_forum_answers_ordering;
-- DROP INDEX IF EXISTS idx_forum_answers_course;
-- DROP INDEX IF EXISTS idx_course_sessions_ordering;
-- DROP INDEX IF EXISTS idx_session_attendance_student_lookup;
-- DROP INDEX IF EXISTS idx_session_attendance_signup;
