        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <header>
              ...
              {/* Role badges - cleaner design with emerald theme */}
              <div className="flex flex-wrap gap-3 mb-8" role="list" aria-label="Professional roles">
                <span
                  className="px-5 py-3 bg-[#10b981]/10 text-[#10b981] font-bold text-sm sm:text-base rounded-lg border border-[#10b981]/30"
                  role="listitem"
                >
            ...
            {/* Social engagement - Focus on connection over sales */}
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-[#111827] border border-[#1f2937] text-white font-bold rounded-lg hover:border-[#10b981] transition-colors text-sm sm:text-base"
                ...
                {/* Newsletter CTA - Less prominent */}
                <div className="pt-4">
                  <Link
                    href="/subscribe"
                    className="group inline-flex items-center gap-2 text-[#d1d5db] hover:text-[#10b981] transition-colors text-sm"
