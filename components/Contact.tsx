...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-pad" style={{ background: '#0a0a0a' }} aria-labelledby="contact-heading">
      <div className="section-container">
        <header className="mb-8">
          <h2 id="contact-heading" className="section-title mb-4 text-white">
        ...
        <div className="mb-12">
          {/* Contact Form */}
          <div className="card-surface"  aria-labelledby="contact-form-heading">

            {status === 'success' && (
              <div className="mb-6 p-4 bg-[#11b981]/10 text-[#11b981] rounded" role="alert" aria-live="polite">
                {t('form.success')}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4" aria-describedby="contact-form-heading">
              ...
              <div>
                ...
                className="w-full px-4 py-3 bg-[#0a0a0a] text-white border border-[#1f2937] rounded focus:border-[#11b981] focus:outline-none transition-colors resize-none"
                aria-required="true"
              />
              </div>
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-[#11b981] text-black font-bold rounded hover:bg-[#0f9f73] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
