        ...
        <div className="space-y-6">
              ...
              {!loadSpotify ? (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-6">
                    ...
                    <div className="w-16 h-16 rounded-full bg-[#11b981] flex items-center justify-center group-hover:bg-[#0f9f73] transition-colors">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="text-[#d1d5db] hover:text-[#11b981] transition-colors text-sm"
