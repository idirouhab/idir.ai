  ...
  return (
    <div className="my-12 border border-gray-200 dark:border-[#1f2937] bg-gray-50 dark:bg-[#0a0a0a] p-8 sm:p-12 rounded-xl relative overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Icon */}
        <div className="mb-6">
          <Mail className="w-12 h-12 text-[#11b981]" strokeWidth={2} />
        </div>

        {/* Label */}
        <p className="text-sm font-bold text-[#11b981] mb-4 uppercase tracking-wide">
          {t('title')}
        </p>
        ...
        <Link
          ...
          className="inline-flex items-center gap-3 px-8 py-4 bg-[#11b981] text-white dark:text-black font-bold uppercase tracking-wide rounded-lg hover:scale-105 transition-all group"
        >
        ...
        <p className="text-sm text-gray-500 dark:text-[#9ca3af] mt-6 font-medium flex items-center gap-2">
          <Check className="w-4 h-4 text-[#11b981]" strokeWidth={2.5} />
          {t('noSpam')}
        </p>
      </div>
    </div>
