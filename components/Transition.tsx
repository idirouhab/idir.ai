    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden" style={{ background: '#0a0a0a' }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4">
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#11b981]/30 to-transparent"></div>
          <p className="text-[#11b981] font-bold text-sm sm:text-base uppercase tracking-wider">
            {t(textKey)}
          </p>
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#11b981]/30 to-transparent"></div>
        </div>
