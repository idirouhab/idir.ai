-- Updated live_events table schema with single title and language field
-- This migration updates the schema to have a single title and event language

-- Drop the old table if you want to start fresh (WARNING: This deletes all data)
